...
class BTCUSDData(AbstractData):
    """
        Concrete implementation of AbstractData for the BTC vs USD ccy pair.
    """
    ...
    def __init__(self):
        """
            Initialize attributes as BTC vs USD asset
        """
        self.__for_ccy = Constants.BITCOIN_CODE
        self.__dom_ccy = Constants.DOLLAR_CODE
        self.__ccy_pair = self.__for_ccy + "/" + self.__dom_ccy
        self.__name = Constants.BITCOIN_NAME + "/" + Constants.DOLLAR_NAME
